                ...
                <div class="main-wrapper">
                    ...
                    <div class="docheader">
                        <p> ერთის მხრივ სს "კ. ერისთავის სახელობის ექსპერიმენტული და კლინიკური
                            ...
                            (შემდგომში "სამედიცინო დაწესებულება") და მეორეს მხრივ მოქალაქე<u>
                                <span>
                        ...
                        <p>
                            <label class="patient-checkbox">
                                <input type="checkbox" name="checkbox" style="checkbox" /> პაციენტი </label>
                                <label
                                class="patient-checkbox">
                                <input type="checkbox" name="checkbox" style="checkbox" /> პაციენტის
                            მეურვე </label> პაციენტი 
                        </p>
                        <p>
                        <label class="patient-checkbox">
                        ...
                        <p>(შემდგომში "პაციენტად" წოდებული) ვდებთ წინამდებარე
