...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
      ...
      <body>
        <header>
          <div class="clinic-logo">
            <svg xmlns="http://www.w3.org/2000/svg" width="159" height="100" viewBox="0 0 160 100">
              ...
              <path style="fill-rule:nonzero;fill:#2a3986;fill-opacity:1;stroke-width:.64;stroke-linecap:butt;stroke-linejoin:miter;stroke:#fff;stroke-opacity:1;stroke-miterlimit:22.93" d="M19.4 15.15h4.89v2.77h9.81v.15H9.59v-.15h9.81Zm0 0" transform="matrix(3.54543 0 0 3.56125 .83 0)"/>
            ...
            <div class="patient-info-wrapper">
              <div class="patient-info-box">
                <div class="patient-info-box-wrapper">
                  ...
                  <p class="patient-info-data fullname"><xsl:value-of select="/Root/FirstName"/><span><xsl:value-of select="/Root/LastName"/></span></p>
                </div>
                <div class="patient-info-box-wrapper">
                  <p class="patient-info-title">ელ-ფოსტა</p>
                  <p class="patient-info-data"><xsl:value-of select="/Root/Email"/></p>
                </div>
                <div class="patient-info-box-wrapper">
                  ...
                  <div class="patient-info-data">
                    <select name="patient-status" id="patient-status" class="patient-status">
                      <option value="ქმედითუნარიანია" selected="selected">ქმედითუნარიანია</option>
                      <option value="ქმედუუნაროა">ქმედუუნაროა</option>
                      <option value="ვერ აწერს ხელს">ვერ აწერს ხელს</option>
                    </select>
                    <span class="patient-status-dropdown"></span>
                  </div>
                </div>
                <div class="patient-info-box-wrapper">
                  <p class="patient-info-title">პირადი ნომერი</p>
                  <p class="patient-info-data"><xsl:value-of select="/Root/ID"/></p>
                </div>
                <div class="patient-info-box-wrapper">
                  <p class="patient-info-title">ტელეფონი</p>
                  <p class="patient-info-data"><xsl:value-of select="/Root/PhoneNumber"/></p>
                </div>
                <div class="patient-info-box-wrapper">
                  <p class="patient-info-title">ისტორიის ნომერი</p>
                  <p class="patient-info-data"><xsl:value-of select="/Root/HistoryNumber"/></p>
                </div>
              </div>
            </div>
          </div>
    ...
    >
          ...
          fill="none"
        >
              <g clip-path="url(#clip0_2454_1154)">
                <path
              d="M12.6459 9.91173C12.3179 9.56973 11.9239 9.38773 11.5039 9.38773C11.0879 9.38773 10.6899 9.56573 10.3499 9.90773L9.28185 10.9717C9.19385 10.9237 9.10585 10.8797 9.02185 10.8357C8.89985 10.7757 8.78585 10.7177 8.68785 10.6577C7.68785 10.0237 6.77985 9.19573 5.90785 8.12573C5.48585 7.59173 5.20185 7.14373 4.99585 6.68773C5.27185 6.43373 5.52985 6.17173 5.77985 5.91773C5.87385 5.82373 5.96985 5.72573 6.